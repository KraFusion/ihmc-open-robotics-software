...
public class FootstepAngularMomentumPredictor implements AngularMomentumTrajectoryGeneratorInterface
{
   ...
   private final FrameVector3D tempFrameVector3 = new FrameVector3D();
   private final FrameVector3D tempFrameVector4 = new FrameVector3D();
   ...
   private void setSwingFootTrajectoryForPhase(int footstepIndex, WalkingTrajectoryType phase, double phaseDuration, RobotSide swingFootSide)
   {
      if(phase == WalkingTrajectoryType.SWING)
      {
         if(footstepIndex == 0 && swingTrajectoryProviders != null && swingFootSide != null)
         {
            ...
            footTrajectory.getVelocity(tempFrameVector3);
            footTrajectory.compute(tFinal);
            footTrajectory.getPosition(tempFramePoint4);
            footTrajectory.getVelocity(tempFrameVector4);

            segmentSwingFootPositionTrajectory
                  .setQuinticTwoWaypoints(t0, tIntermediate0, tIntermediate1, tFinal, tempFramePoint1, tempFrameVector1, tempFramePoint2, tempFramePoint3, tempFramePoint4, tempFrameVector4);
         }
         else
         {
